...
import fs from 'fs';
const dataFilePath = 'studentData.json';
class Student {
    name;
    rollNo;
    age;
...
async function welcome() {
    const chalkTitle = chalkAnimation.rainbow("Welcome to Student Management System.");
    await sleep();
    chalkTitle.stop();
}
...
async function main() {
    ...
    function displayStudents() {
        ...
        students.forEach((student, index) => {
            console.log(`${index + 1}. Student Name: ${student.name}, Roll No: ${student.rollNo}, Age: ${student.age}, Grade: ${student.grade}, Class: ${student.studentClass}, Section: ${student.section}`);
        });
        console.log('\n');
    }
        ...
        inquirer
            ...
            switch (answers.action) {
                ...
                case 'List Students':
                    ...
                    break;
                case 'Exit':
                    console.log(chalk.bold('App Closed!'));
                    process.exit();
            }
        });
    }
